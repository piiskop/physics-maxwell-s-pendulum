...
description: "Tallinna Ülikooli mehaanika praktikumi kursuse \"Maxwelli pendli\" praktilise ülesande peacecop kalmeri: raport."
lang: et
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'LABORATOORNE TÖÖ 5<br/>Maxwelli pendel' }`"
