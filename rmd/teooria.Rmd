...
\begin{align}
I_\text{r} &= I - I_0 =\\
-(m_0 + m_\text{r}) \times r^2 \times (\frac{g \times t^2}{2 \times h} + 1) - (-m_0 \times r^2 \times (\frac{g \times t^2}{2 \times h} + 1)) &=\\
r^2 \times (\frac{g \times t^2}{2 \times h} + 1) \times (m_0 -m_0 - m_\text{r}) &=\\
r^2 \times (\frac{g \times t^2}{2 \times h} + 1) \times (-m_\text{r}) &=\\
-m_\text{r} \times r^2 \times (\frac{g \times t^2}{2 \times h} + 1).
(\#eq:I-of-ring)
\end{align}
